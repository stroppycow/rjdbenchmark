...

{
  ...
  var data_generalite = [
    ...
    },
    {
      ...
      'old': format_stat_jd(null, infos_old_sel['summary']),
      'new': format_stat_jd(null, infos_new_sel['summary'])
    },
    {
      'label':'Version du cruncher utilisée',
      'old': infos_old_sel['version'],
      'new': infos_new_sel['version']
    },
        {
      'label':'Mode de rafraichissement',
      'old': infos_old_sel['refresh_policy'],
      'new': infos_new_sel['refresh_policy']
    },
    {
...
```{ojs}
//| echo: false
relayout_plotly_ts = function(data, id){
...
legend_click_plotly_ts = function(data, id){
